...
export const useLayoutConfigStore = defineStore('layoutConfig', () => {
  ...
  // 👉 Misc — composables fuera de computed: usar useMediaQuery dentro de computed rompe la suscripción al viewport
  const isLessThanOverlayNavBreakpoint = useMediaQuery(
