...
export const createLayouts = userConfig => {
  return () => {
    ...
    // No pisar isVerticalNavCollapsed ni otros cookieRef ya definidos en el store: un $patch con
    // el valor primitivo puede romper la ref/cookie y el colapsar del panel deja de actualizar el layout.
    configStore.$patch({
